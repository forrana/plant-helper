...
SECRET_KEY = os.getenv('SECRET', 'django-insecure--%m6!41^2r$1$iw8klx_gos&uad7f==h)$0(aocvxxg!mi_&%e')
...
def get_email_backend(is_debug):
    if is_debug:
...
WEBPUSH_SETTINGS = {
    ...
    'VAPID_ADMIN_EMAIL': os.getenv('EMAIL_ACCOUNT')
}